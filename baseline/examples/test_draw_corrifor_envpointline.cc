 ...
 * @Date: 2023-08-12 10:13:08
 * @LastEditTime: 2023-08-29 02:56:56
 * @LastEditors: yanyan-li yanyan.li.camp@gmail.com
 * @Description:
 * @FilePath: /JointFactorGraph/examples/test_draw_corrifor_envpointline.cc
 */
...
{  
  ...
  while( !pangolin::ShouldQuit())
  {
    ...
    if(d_cam.IsShown()) {
        ...
        // AddCorridorPart(cube_top_planes, frame_line_color);
        // AddCorridorPart(cube_right_planes, frame_line_color);
        // AddCorridorPart(cube_left_planes, frame_line_color);
        // AddCorridorPart(cube_bottom_planes, frame_line_color);
        DrawOrigin();
        DrawCoordiante();
